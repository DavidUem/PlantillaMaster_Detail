package com.example.david.fragmentos;
...
import com.example.david.fragmentos.dummy.DummyContent;
...
public class PublicacionBlogDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.publicacionblog_detail)).setText(mItem.content);
        }
